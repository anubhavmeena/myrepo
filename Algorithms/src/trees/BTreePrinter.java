...
public class BTreePrinter {
    ...
    public static <T extends Comparable<T>> void printNodeInternal(List<Node<T>> nodes, int level, int maxLevel) {
    ...
    public static <T extends Comparable<T>> int maxLevel(Node<T> node) {
        if (node == null)
            return 0;
